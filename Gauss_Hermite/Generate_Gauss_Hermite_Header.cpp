//
//  Generate_Gauss_Hermite_Header.cpp
//  
//
...
void generate_File(int n) {
        ...
        string fileName         =       "./header/Gauss_Hermite_Nodes_and_Weights_";
        ...
        myhppfile << "//" << endl;
        myhppfile << "//        Gauss_Hermite_Nodes_and_Weights_" << n << ".hpp" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Created by Sivaram Ambikasaran on " << currentDateTime() << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Array of nodes and weights for Gauss Hermite quadrature of order " << n << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl << endl;
        myhppfile << "#ifndef __Gauss_Hermite_Nodes_and_Weights_" << n << "_hpp__" << endl;
        myhppfile << "#define __Gauss_Hermite_Nodes_and_Weights_" << n << "_hpp__" << endl << endl;
        myhppfile << "void Gauss_Hermite_Nodes_and_Weights_" << n << "(long double*& nodes, long double*& weights) {" << endl;
        ...
        myweightsFile.close();
        myhppfile << "}" << endl;
        myhppfile << "#endif /*(__Gauss_Hermite_Nodes_and_Weights_" << n << "_hpp__)*/";
        myhppfile.close();
}

//      Generates a single file for different number of nodes.
void generate_Main_File(int N) {
        string fileName         =       "./header/Gauss_Hermite_Nodes_and_Weights.hpp";
        ...
        myhppfile << "//" << endl;
        myhppfile << "//        Gauss_Hermite_Nodes_and_Weights.hpp" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Created by Sivaram Ambikasaran on " << currentDateTime() << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Array of nodes and weights for Gauss Hermite quadrature of order between 1 and " << N << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl << endl;
        myhppfile << "#ifndef __Gauss_Hermite_Nodes_and_Weights_hpp__" << endl;
        myhppfile << "#define __Gauss_Hermite_Nodes_and_Weights_hpp__" << endl << endl;
        myhppfile << "#include <cassert>" << endl << endl;
//        for (int k=0; k<N; ++k) {
//                myhppfile << "#include \"Gauss_Hermite_Nodes_and_Weights_" << k+1 << ".hpp\"" << endl;
//        }
        string nodesFile;
        string weightsFile;
        ifstream mynodesFile;
        ifstream myweightsFile;
        myhppfile << "void Gauss_Hermite_Nodes_and_Weights(int N, long double*& nodes, long double*& weights) {" << endl;
        ...
        myhppfile << "\t}" << endl;
        myhppfile << "}" << endl;
        myhppfile << "#endif /*(__Gauss_Hermite_Nodes_and_Weights_hpp__)*/";
        myhppfile.close();
}
