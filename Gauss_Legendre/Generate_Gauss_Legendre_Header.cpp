//
//  Generate_Gauss_Legendre_Header.cpp
//  
//
...
void generate_File(int n) {
        ...
        string fileName         =       "./header/Gauss_Legendre_Nodes_and_Weights_";
        ...
        myhppfile << "//" << endl;
        myhppfile << "//        Gauss_Legendre_Nodes_and_Weights_" << n << ".hpp" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Created by Sivaram Ambikasaran on " << currentDateTime() << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Array of nodes and weights for Gauss Legendre quadrature of order " << n << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl << endl;
        myhppfile << "#ifndef __Gauss_Legendre_Nodes_and_Weights_" << n << "_hpp__" << endl;
        myhppfile << "#define __Gauss_Legendre_Nodes_and_Weights_" << n << "_hpp__" << endl << endl;
        myhppfile << "void Gauss_Legendre_Nodes_and_Weights_" << n << "(long double*& nodes, long double*& weights) {" << endl;
...
void generate_Main_File(int N) {
        string fileName         =       "./header/Gauss_Legendre_Nodes_and_Weights.hpp";
        ...
        myhppfile << "//" << endl;
        myhppfile << "//        Gauss_Legendre_Nodes_and_Weights.hpp" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Created by Sivaram Ambikasaran on " << currentDateTime() << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl;
        myhppfile << "//        Array of nodes and weights for Gauss Legendre quadrature of order between 1 and " << N << "." << endl;
        myhppfile << "//" << endl;
        myhppfile << "//" << endl << endl;
        myhppfile << "#ifndef __Gauss_Legendre_Nodes_and_Weights_hpp__" << endl;
        myhppfile << "#define __Gauss_Legendre_Nodes_and_Weights_hpp__" << endl << endl;
        myhppfile << "#include <cassert>" << endl << endl;
//        for (int k=0; k<N; ++k) {
//                myhppfile << "#include \"Gauss_Legendre_Nodes_and_Weights_" << k+1 << ".hpp\"" << endl;
//        }
        string nodesFile;
        string weightsFile;
        ifstream mynodesFile;
        ifstream myweightsFile;
        myhppfile << "void Gauss_Legendre_Nodes_and_Weights(int N, long double*& nodes, long double*& weights) {" << endl;
        myhppfile << "\tassert(N>=1 && \"Number of nodes must be atleast 1.\");" << endl;
        myhppfile << "\tassert(N<=128 && \"Currently, the maximum number of nodes is only " << N << ".\");" << endl;
